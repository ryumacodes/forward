...
export function trustedIntroduction(businessName: string, callbackNumber: string) {
  return `Hi, I’m Sarah, SourcePilot’s AI procurement assistant, calling on behalf of ${businessName}. This is a quote enquiry, not an order. You can ask me to stop at any time, or call ${callbackNumber} to verify the request.`
}
