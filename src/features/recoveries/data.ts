...
export function createDemoSeed(now = new Date()): { recoveries: Recovery[]; offers: Offer[] } {
  ...
  return {
    recoveries: [
      { id: 'REC-024', item: 'Chicken breast', quantity: 30, unit: 'kg', budget: 350, deadline: primaryDeadline, location: '24 Flinders Lane, Melbourne', status: 'Needs approval', category: 'Poultry · Fresh produce', minimumPaymentDays: 14, maximumDepositPercent: 0 },
      { id: 'REC-023', item: 'Takeaway containers', quantity: 500, unit: 'units', budget: 180, deadline: packagingDeadline, location: '24 Flinders Lane, Melbourne', status: 'Calling suppliers', category: 'Packaging' },
      { id: 'REC-022', item: 'Extra virgin olive oil', quantity: 20, unit: 'L', budget: 260, deadline: approvedDeadline, location: '24 Flinders Lane, Melbourne', status: 'Approved', category: 'Pantry' },
    ],
    offers: [
...
export const initialRecoveries = demoSeed.recoveries
